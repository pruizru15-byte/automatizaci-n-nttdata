...
const fs = {
    ...
    async hasAccess(path) {
        try {
            await node_fs_1.promises.access(path, node_fs_1.constants.R_OK);
        }
        catch {
            return false;
        }
    ...
    async isExecutable(path) {
        try {
            ...
            await node_fs_1.promises.access(path, node_fs_1.constants.R_OK | node_fs_1.constants.X_OK);
        }
        catch {
            return false;
        }
    ...
    readPackageJsonFrom(dir, opts = {}) {
        ...
        try {
            return (0, read_pkg_1.readPackageSync)(
    ...
    close: bluebird_1.default.promisify(node_fs_1.close),
     ...
     */
    open: bluebird_1.default.promisify(node_fs_1.open),
    openFile: node_fs_1.promises.open,
    readdir: node_fs_1.promises.readdir,
    read: /**
     * @type {ReadFn<NodeJS.ArrayBufferView>}
     */ ( /** @type {unknown} */(bluebird_1.default.promisify(node_fs_1.read))),
